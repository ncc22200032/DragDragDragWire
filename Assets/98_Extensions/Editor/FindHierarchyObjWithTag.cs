...
public class FindHierarchyObjWithTag : EditorWindow
{
    ...
    // エディターのメニューバーに追加
    [MenuItem("ExTools/Find GameObjects In Scene With Tag...", priority = 22)]
    static void Init()
    {
        FindHierarchyObjWithTag window = EditorWindow.GetWindow<FindHierarchyObjWithTag>("Find With Tag");
